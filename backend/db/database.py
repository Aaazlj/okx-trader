...
async def _seed_default_strategies(db: aiosqlite.Connection):
    ...
    defaults = [
        ...
        },
        {
            ...
            "params": json.dumps({
                "smma_period": 170,
                "spike_short_min_dist_pct": 1.0,
                "spike_short_max_dist_pct": 5.5,
                "spike_short_ret_15m_min": 0.8,
                "spike_short_ret_60m_min": 0.8,
                "spike_short_upper_wick_min_range_pct": 0.15,
                "short_take_profit_pct": 0.9,
                "short_stop_loss_pct": 1.8,
                "short_max_ret_720m_pct": 2.5,
                "short_max_ema_spread_pct": 0.1,
            }),
        },
        {
            "id": "mean_reversion",
            ...
            "params": json.dumps({
                "smma_period": 170,
                "short_entry_min_dist_pct": 1.2,
                "short_entry_max_dist_pct": 3.2,
                "short_ret_15m_min": 0.3,
                "short_ret_60m_min": 1.0,
                "short_take_profit_pct": 0.6,
                "short_stop_loss_pct": 3.0,
                "require_upper_wick_short": True,
                "short_upper_wick_min_range_pct": 0.15,
            }),
        },
        # ═══════════════════════════════════════════
        # ai-bian AI 驱动策略
